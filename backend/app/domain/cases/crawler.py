...
def _fraud_profile(fraud_type: str | None) -> dict:
    profiles = {
        "AI拟声冒充亲友": {
            ...
            "roles": ["elder", "office_worker", "mother"],
        ...
        "求职培训诈骗": {
            ...
            "roles": ["student", "young_social", "office_worker"],
        ...
        "虚假投资诈骗": {
            ...
            "roles": ["investor", "elder", "office_worker", "finance"],
        ...
        "骗保骗补": {
            "tags": ["养老金", "补贴", "骗保", "民生资金"],
            "roles": ["elder", "office_worker", "finance"],
        ...
        "民生消费诈骗": {
            ...
            "roles": ["mother", "elder", "office_worker"],
        ...
        "洗钱跑分": {
            "tags": ["洗钱", "代购", "奢侈品", "跑分"],
            "roles": ["young_social", "student", "office_worker", "finance"],
        ...
        "跨境电诈": {
            ...
            "roles": ["investor", "young_social", "office_worker"],
        ...
        "电信网络诈骗": {
            ...
            "roles": ["office_worker", "student", "mother", "investor", "minor", "young_social", "elder", "finance"],
